...
export default class DOMController {
  ...
  static loadTodos(todos) {
    todos.forEach((todoDetails) => {
      let [todoId, priority, isFinished, title, timeLeft, dueDate, projectId] =
        todoDetails;
      $(".todos-area").append(`
            <div class='todo' data-UUID=${todoId} data-project-uuid=${projectId}>
                ...
                <input data-UUID=${todoId} data-project-uuid=${projectId} class="todo-checkbox" type="checkbox" ${
        isFinished ? "checked" : "unchecked"
      }>
  ...
  static openAddProjectForm() {
    $("#add-project-button").replaceWith(`                
  ...
  static openChangeNameTextInput(e) {
    ...
    $(".todo-title[data-uuid=" + todoId + "]").replaceWith(`
  ...
  static openPriorityInput(e) {
    ...
    $(".todo-priority-indicator[data-uuid=" + todoId + "]").replaceWith(`
  ...
  static editTodo(e) {
    ...
    let priority =
      todoToEdit.find(".todo-priority-indicator").data("priority") ||
      todoToEdit.find(".todo-priority-picker").val();
