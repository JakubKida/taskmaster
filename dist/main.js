...
class Project {
    ...
    addToDo(title,dueDate,priority,id){
        this._toDos.push(new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.default(title,this._name,dueDate,priority,id))
    }
...
class ProjectsList{
    ...
    addProject(projectName,projectId,todosList){
        ...
        this._projects.push(new _Project__WEBPACK_IMPORTED_MODULE_0__.default(projectName,projectId,todosList));
        return true;
        } else {
            return false;
        }
...
/* harmony export */ });
/* harmony import */ var _Project__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Project */ "./src/modules/Project.js");
/* harmony import */ var _ProjectsList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProjectsList */ "./src/modules/ProjectsList.js");
...
class StorageController{
    ...
    static loadFromStorage(){
        let projectList = new _ProjectsList__WEBPACK_IMPORTED_MODULE_1__.default();
...
class ToDo {
    ...
    displayItems(){
        ...
        console.log(`Time Left: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(this._dueDate,new Date())}`);
    }
    ...
    getTimeLeft(){
        ...
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(this._dueDate),new Date());
    }
}
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_ProjectsList_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/ProjectsList.js */ "./src/modules/ProjectsList.js");
/* harmony import */ var _modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/StorageController.js */ "./src/modules/StorageController.js");
...
let sampleProjectList = new _modules_ProjectsList_js__WEBPACK_IMPORTED_MODULE_0__.default();
let exampPro = new _modules_Project_js__WEBPACK_IMPORTED_MODULE_2__.default('Lala');
...
_modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.loadFromStorage();
...
_modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.addNewProject('lala');
_modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.addNewProject('lalaraj');
let uuid = _modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.listAllProjects()
console.log(_modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.listAllProjects());
_modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.addTodo(uuid[0][0],'Jojo',sampleDate,0);
...
// console.log();
console.table(_modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.listAllTodosFromProject(uuid[0][0]));
_modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.deleteTodo(uuid[0][0],'f1ee642e-43c7-44b1-98c5-c8d1300e606b');
console.table(_modules_StorageController_js__WEBPACK_IMPORTED_MODULE_1__.default.listAllTodosFromProject(uuid[0][0]));
